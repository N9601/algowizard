...
export default function AStarPage() {
  ...
  return (
    <>
      ...
      <AlgorithmLayout
        title="A* Pathfinding"
        description="A* combines the cost so far with a heuristic to expand the most promising grid cell first."
        time="O(E)"
        space="O(V)"
        category="Graph"
        difficulty="Medium"
        ...
        actions={
          <div className="space-y-3">
            <SaveVisualizationButton
              ...
              route="/visualizer/pathfinding/a-star"
              disabled={!step}
              getPayload={() => ({
      ...
      >
        ...
        <Controls
          ...
          statusText="Heuristic-guided search in progress"
          onReset={() => {
            controllerRef.current?.reset();
